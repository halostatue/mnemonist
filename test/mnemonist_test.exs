defmodule MnemonistTest do
  ...
  @seed_english_default <<94, 176, 11, 189, 220, 240, 105, 8, 72, 137, 168, 171, 145, 85, 86, 129, 101, 245, 196, 83,
                          204, 184, 94, 112, 129, 26, 174, 214, 246, 218, 95, 193, 154, 90, 196, 11, 56, 156, 211, 112,
                          208, 134, 32, 109, 236, 138, 166, 196, 61, 174, 166, 105, 15, 32, 173, 61, 141, 72, 178, 210,
                          206, 158, 56, 228>>
  @seed_english_trezor <<197, 82, 87, 195, 96, 192, 124, 114, 2, 154, 235, 193, 181, 60, 5, 237, 3, 98, 173, 163, 142,
                         173, 62, 62, 158, 250, 55, 8, 229, 52, 149, 83, 31, 9, 166, 152, 117, 153, 209, 130, 100, 193,
                         225, 201, 47, 44, 241, 65, 99, 12, 122, 60, 74, 183, 200, 27, 47, 0, 22, 152, 231, 70, 59, 4>>

  @seed_spanish_default <<253, 254, 155, 124, 122, 94, 80, 121, 187, 54, 214, 56, 24, 56, 134, 122, 52, 53, 141, 176,
                          160, 48, 125, 6, 10, 219, 175, 94, 218, 219, 8, 176, 168, 124, 6, 237, 225, 169, 106, 253,
                          133, 102, 239, 73, 151, 146, 255, 203, 211, 127, 67, 246, 245, 84, 250, 52, 65, 56, 102, 14,
                          172, 222, 252, 248>>
  @seed_spanish_trezor <<41, 162, 238, 22, 222, 71, 208, 112, 37, 222, 55, 231, 217, 197, 150, 134, 148, 57, 249, 188,
                         210, 106, 112, 45, 43, 174, 100, 219, 43, 240, 246, 131, 131, 132, 28, 84, 68, 181, 179, 189,
                         57, 221, 114, 13, 46, 190, 89, 150, 158, 17, 14, 89, 85, 200, 230, 211, 44, 108, 50, 148, 253,
                         135, 67, 155>>
  ...
  describe "valid_mnemonic?/2" do
    ...
    test "is false (other cases)" do
      refute valid_mnemonic?("turtle front uncle idea crush write shrug there lottery flower risky shell")

      refute valid_mnemonic?("sleep kitten sleep kitten sleep kitten sleep kitten sleep kitten sleep kitten")
    end
  end
